...
@property (nonatomic, strong) KSMineHeadView *headView;//顶部图片
@property (nonatomic, strong) KSTableHeaderView *headerView;//滚动的NSObject类
@property (nonatomic, strong) KSMineNavView *navView;//导航栏
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    if (section == 0) {//表示第0部分有两行item
        return 2;
    } else {//section不为0表示有4行
